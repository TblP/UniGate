...
> - Play Protect и HyperOS всё равно могут предупредить, что APK получен не из магазина: в Android подпись всегда самоподписанная, и доверие определяется источником установки, а не сертификатом.
> - **С версии 1.2.0 сменился сертификат подписи** — сборка переведена с отладочной на релизную. Обновление поверх более ранней версии не встанет: удалите её перед установкой, предварительно сохранив профили через «Поделиться».
